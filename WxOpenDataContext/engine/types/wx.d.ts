...
declare namespace wx {
  ...
  export function shareMessageToFriend(obj: { openId: string, title?: string, imageUrl?: string, imageUrlId?: string });
  export function setMessageToFriendQuery(obj: { shareMessageToFriendScene: number, query: string }): boolean;


  export function shareAppMessage(obj: { title?: string, imageUrl?: string, imageUrlId?: string, query?: string, imageUrlId?: string }): void;

  export function getGroupCloudStorage(object): void;

  /**
   * 获取可能对游戏感兴趣的未注册的好友名单。
   */
  export function getPotentialFriendList(object): void;
}
