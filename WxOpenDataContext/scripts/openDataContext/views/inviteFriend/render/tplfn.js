...
module.exports = function tplFn(it) {
  ...
  var bgImg =
    images["ui_frame_qswj_d.png"] || "openDataContext/image/ui_frame_qswj_d.png";
  var avatarFallback =
    images["icon_800000.png"] || "openDataContext/image/icon_800000.png";
  var btnImg =
    images["ui_btn_ty_g2.png"] || "openDataContext/image/ui_btn_ty_g2.png";
  ...
  if (data.length === 0) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      out += '<image class="img_bg" src="' + escAttr(bgImg) + '"></image>';
