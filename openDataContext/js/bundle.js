(() => {
  ...
  var _InviteOpenDataModule = class _InviteOpenDataModule {
    ...
    onStageResize() {
      ...
      this._inviteView.layoutChildren();
    }
    ...
    shareToWxFriend(openid) {
      ...
      if (wx.shareMessageToFriend) {
        wx.shareMessageToFriend(Object.assign({ openId: openid }, sharePayload));
        return;
      }
      if (wx.shareAppMessage) {
        wx.shareAppMessage(Object.assign({ imageUrlId: this._shareConfig.shareImageUrlId }, sharePayload));
      }
    }
